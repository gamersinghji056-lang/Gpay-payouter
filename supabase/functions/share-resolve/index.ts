...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const [ledger, deposits, qrs, merchantSettlements, withdrawals, upiAccounts] = await Promise.all([
    ...
    if (ledger.error || deposits.error || qrs.error || merchantSettlements.error || withdrawals.error || upiAccounts.error) throw ledger.error || deposits.error || qrs.error || merchantSettlements.error || withdrawals.error || upiAccounts.error;
